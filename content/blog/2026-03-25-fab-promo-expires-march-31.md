...
![UAE savings rate comparison: FAB promotional 4% ending March 31 vs Vault ~5.4% current no lock-in](/blog/fab-promo-expires-march-31.svg)

# FAB's 4% Savings Rate Expires in One Week. Here's What to Do.
...
Banks use promotional rates to attract deposits. FAB's 4% campaign was designed to pull in new balances. Now that the campaign window is closing, the incentive is gone — and so is the rate.
...
The decision is yours. Make it before the 31st.
