...
Vault earns ~5.4% currently from fees generated by vetted lending markets through the Sentora PYUSD vault. The rate is variable and not guaranteed, but it's not a promotional teaser designed to expire. It reflects actual fees from institutional borrowers — the same institutional lending markets that have deployed over $3 billion.
...
*Vault earns ~5.4% currently from fees charged to borrowers in vetted lending markets. Rate is variable and not guaranteed. Join the waitlist at [vlt.money](https://vlt.money).*
