...
**Market-rate pricing.** Rates reflect actual supply and demand, rather than a bank's decision about how much they need to pay to retain deposits.
...
We don't publish the full list of markets we use — that's part of what you're trusting us to manage.

## Variable rates: what to expect

The ~5.4% current rate we show reflects current market conditions. Rates change as borrowing demand and capital supply shift. In practice:
