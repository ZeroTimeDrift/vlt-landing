  ...
  return (
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="/ar" className="hidden md:inline text-sm text-vault-muted hover:text-vault-text-dim transition-colors" style={{ fontFamily: "'Noto Sans Arabic', sans-serif" }}>العربية</a>
      ...
      <main>
        ...
        <section
          id="waitlist"
          className="min-h-screen flex items-center px-6 pt-28 pb-16 hero-grid relative"
        >
          ...
          <div className="max-w-6xl mx-auto w-full" style={{ position: "relative", zIndex: 2 }}>
            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
              ...
              {/* LiveBalanceCard — wrapped in phone frame */}
