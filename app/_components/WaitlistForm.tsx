...
export default function WaitlistForm({
  ...
  if (status === "success") {
    const whatsappText = encodeURIComponent(
      "Found a way to earn ~5.4% on savings in UAE — no lock-ups. vlt.money \u{1F512}"
    );
    const xText = encodeURIComponent(
      "Found a way to earn ~5.4% on UAE savings — no promo, no lock-ups. vlt.money"
    );
        ...
        {waitlistCount !== null && waitlistCount >= 50 && (
          <div className="mt-3">
            <p className="text-[12px] text-vault-muted mb-2">
              Know someone with savings stuck at 2%?
            </p>
